...
static u64 get_cur_time(void) {
  ...
  //printf("u64 get_cur_time(void)\n");
  
  struct timeval tv;
  struct timezone tz;

  gettimeofday(&tv, &tz); //> f1.txt
...
/* Begin FMSE code */
/*    fprintf(stderr, "FMSE> Adding test input %s to queue.\n", fname);
    if (queue_cur != 0)
      fprintf(stderr, "FMSE> Parent is %s.\n", queue_cur->fname); */
/* End FMSE code */
...
/* Begin FMSE code */
/*    fprintf(stderr, "FMSE> Test input %s has become favorite for bp
 *    %d.\n", q->fname, i); */
/* End FMSE code */
...
static u8 fuzz_one(char** argv) {
  ...
  /* Begin FMSE code */
  /*
  fprintf(stderr, "FMSE> Selected test input id:%s for fuzzing.\n", 
     queue_cur->fname); 
  fprintf(stderr, queue_cur->was_fuzzed ? 
       "FMSE> Was fuzzed in the past.\n" : 
       "FMSE> Was not fuzzed in the past.\n");
  fprintf(stderr, queue_cur->favored ? 
       "FMSE> Is favored.\n" : 
       "FMSE> Is not favored.\n");  
       */
  /* End FMSE code */
...
int main(int argc, char** argv) {
  ...
  while (1) {
    ...
    if (!queue_cur) {
      ...
      queue_cycle++;
      /* Begin FMSE code */
/*       fprintf(stderr, "FMSE> Going to cycle %llu\n", queue_cycle); */
      /* End FMSE code */
